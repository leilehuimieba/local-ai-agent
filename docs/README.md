...
5. 如果继续做下一阶段产品收口，当前默认主线应理解为 `知识沉淀型个人助手`，而不是继续扩成全能平台。
...
5. [知识沉淀型个人助手模块分层清单_V1](D:/newwork/本地智能体/docs/06-development/知识沉淀型个人助手模块分层清单_V1.md)
6. [知识沉淀型个人助手开发路线图_V1](D:/newwork/本地智能体/docs/06-development/知识沉淀型个人助手开发路线图_V1.md)
7. [知识沉淀型个人助手下一阶段开发任务书_V1](D:/newwork/本地智能体/docs/06-development/知识沉淀型个人助手下一阶段开发任务书_V1.md)

历史只读：

1. 历史任务书状态，统一见 [开发文档收口导航_V1](D:/newwork/本地智能体/docs/06-development/开发文档收口导航_V1.md)
2. 已迁移与待迁移的历史阶段文档，统一见 [历史阶段文档迁移记录与候选清单_V1](D:/newwork/本地智能体/docs/archive/历史阶段文档迁移候选清单_V1.md)
...
6. [本地记忆与知识沉淀验收文档_V1](D:/newwork/本地智能体/docs/07-test/本地记忆与知识沉淀验收文档_V1.md)
7. [SQLite 主存储验收文档_V1](D:/newwork/本地智能体/docs/07-test/SQLite 主存储验收文档_V1.md)
8. [思源外挂知识库接入验收文档_V1](D:/newwork/本地智能体/docs/07-test/思源外挂知识库接入验收文档_V1.md)
9. [工作区与授权策略产品化验收文档_V1](D:/newwork/本地智能体/docs/07-test/工作区与授权策略产品化验收文档_V1.md)
10. [前端产品化验收文档_V1](D:/newwork/本地智能体/docs/07-test/前端产品化验收文档_V1.md)
11. [首页状态化验收文档_V1](D:/newwork/本地智能体/docs/07-test/首页状态化验收文档_V1.md)
12. [智能体框架主干总体验收文档_V1](D:/newwork/本地智能体/docs/07-test/智能体框架主干总体验收文档_V1.md)
13. [知识沉淀型个人助手下一阶段验收文档_V1](D:/newwork/本地智能体/docs/07-test/知识沉淀型个人助手下一阶段验收文档_V1.md)

历史只读：

1. 历史阶段验收材料状态，统一见 [关键入口文档](D:/newwork/本地智能体/docs/07-test/关键入口文档.md)
2. 已迁移与待迁移的历史阶段文档，统一见 [历史阶段文档迁移记录与候选清单_V1](D:/newwork/本地智能体/docs/archive/历史阶段文档迁移候选清单_V1.md)
...
9. [首页状态化验收文档_V1](D:/newwork/本地智能体/docs/07-test/首页状态化验收文档_V1.md)
10. [V2前端视觉与界面实现方案_V1](D:/newwork/本地智能体/docs/10-v2/V2前端视觉与界面实现方案_V1.md)
...
1. `当前执行域优先稳定，不做无计划扩散`
2. `历史阶段文档先降级，再按清单物理迁移或删除`
3. `入口文档与 archive 清单保持同步，避免断链`

这样做的原因：

1. 统一口径，不让历史材料继续干扰当前主线
2. 保留追溯能力，同时降低目录噪音
3. 通过先检索后迁移，控制引用失效风险
...
为了避免“为整理而整理”，后续整理默认遵循以下止损线：

1. 若候选文档仍是当前入口链路的直接依赖（出现在 `README`、`开发文档收口导航`、`关键入口文档` 的当前入口区），默认不迁移。
2. 若候选文档在全仓被引用次数 `>= 5`，默认按“当前参考文档”保留，不再优先清理。
3. 若一次迁移需要改动超过 `10` 处上游文档但只减少 `1` 份候选文件，视为收益过低，暂停该候选。
4. 若连续两轮整理都未降低入口阅读成本（入口文档长度和入口数量基本不变），暂停物理迁移，只做口径维护。
5. 当前剩余文档以“稳定主线”为优先，后续只在新阶段正式启动时再做下一轮归档评估。
