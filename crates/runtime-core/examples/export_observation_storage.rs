use runtime_core::{ModelRef, ProviderRef, RunEvent, RunRequest, WorkspaceRef, persist_lifecycle_observations};
use serde_json::json;
...
fn sample_request() -> RunRequest {
    let workspace_id = format!("workspace-m1-{}", unix_millis());
    RunRequest {
        request_id: "mem-06-request".to_string(),
        run_id: "run-m1".to_string(),
        session_id: "session-m1".to_string(),
        trace_id: "trace-m1".to_string(),
        user_input: "memory lifecycle storage export".to_string(),
