...
mod tests {
    ...
    fn sample_action_requested_event() -> RunEvent {
        RunEvent {
            ...
            source: "runtime".to_string(),
            record_type: String::new(), source_type: String::new(),
            agent_id: "primary".to_string(), agent_label: "主智能体".to_string(),
            event_type: "action_requested".to_string(), trace_id: "trace-1".to_string(),
            session_id: "session-1".to_string(), run_id: "run-1".to_string(), sequence: 1,
            timestamp: "1".to_string(), stage: "Execute".to_string(),
            summary: "准备恢复动作".to_string(), detail: String::new(),
            tool_name: String::new(), tool_display_name: "执行命令".to_string(),
            tool_category: "system_command".to_string(), output_kind: "text_preview".to_string(),
            result_summary: String::new(), artifact_path: String::new(),
            risk_level: "high".to_string(), confirmation_id: String::new(),
            final_answer: String::new(), completion_status: String::new(),
            completion_reason: String::new(), verification_summary: String::new(),
            checkpoint_written: false, context_snapshot: None,
            tool_call_snapshot: None, verification_snapshot: None,
