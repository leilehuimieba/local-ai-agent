...
export type RuntimeContextSnapshot = {
  ...
  observation_injection?: string;
  observation_references?: string;
  observation_budget_total?: number;
  observation_budget_used?: number;
  observation_budget_hit?: boolean;
  observation_budget_total_tokens?: number;
  observation_budget_used_tokens?: number;
  observation_budget_hit_tokens?: boolean;
